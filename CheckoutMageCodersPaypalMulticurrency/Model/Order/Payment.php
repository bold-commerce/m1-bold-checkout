...
/**
 * Paypal multi currency payment rewrite to fix closed transactions issue.
 */
class Bold_CheckoutMageCodersPaypalMulticurrency_Model_Order_Payment
    extends MageCoders_PaypalMulticurrency_Model_Sales_Order_Payment
{
    /**
     * @inheritDoc
     */
