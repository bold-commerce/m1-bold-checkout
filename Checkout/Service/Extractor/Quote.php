...
class Bold_Checkout_Service_Extractor_Quote
{
    ...
    private static function extractQuote(Mage_Sales_Model_Quote $quote)
    {
        ...
        return [
            ...
            'customer' => [
                'email' => $quote->getCustomer() ? $quote->getCustomer()->getEmail() : null,
                'firstname' => $quote->getCustomer() ? $quote->getCustomer()->getFirstname() : null,
                'lastname' => $quote->getCustomer() ? $quote->getCustomer()->getLastname() : null,
            ],
